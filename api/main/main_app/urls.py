...
from .views import (Login, ConfirmCode, Verify, UpdateUserProfile, DeleteAccount,
                    CreateSalesMan, UpdateSalesManProfile, ProductManagement, CategoryManagement)
...
urlpatterns = [
    ...
    re_path(r'^create-salesman/?$', CreateSalesMan.as_view(), name='salesman'),
    re_path(r'^update-salesman/?$', UpdateSalesManProfile.as_view(), name='salesman'),
